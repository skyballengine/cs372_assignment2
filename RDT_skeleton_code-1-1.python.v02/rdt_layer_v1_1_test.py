    ...
    def processSend(self):
        ...
        if self.name == "client":
            ...
            # fill up window
                ...
                while ((seqnum < len(self.dataToSend)) and segnum < 3):
                    data = ''
            ...
            for segment in listIncomingSegments:
                if segment.payload:
                    ...
                    if segment.checkChecksum():
                        ...
                        #TODO current changes need to test
                    ...
                    if (segment.seqnum != self.cumulativeAckNum) or (not segment.checkChecksum()):
                        ...
                        # figuring out how to ack for lost packets after 3 iterations
                        # do I need to increment self.cumulativeACK?
                        #TODO current changes need to test
